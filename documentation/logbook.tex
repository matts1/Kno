...
\log[21 January][
Added gantt chart and pseudocode for searching][
Added searching functionality][
Added ability to join courses and wrote tests for them][
Changed layout of website]

\log[22 January - 2 February][
Migrated code to django]